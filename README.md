...
SparkMap can also function with [TopHat](https://ccb.jhu.edu/software/tophat/index.shtml) and works well with [STAR](https://physiology.med.cornell.edu/faculty/skrabanek/lab/angsd/lecture_notes/STARmanual.pdf) when large numbers of cores or machines are available.*
